...
extern float pointLoad [10] [2]; //pointLoad array is used to store forces acting on a beam
extern float distributedLoad [5] [2]; //distributedLoad array is used to store distributed load, where magnitude per length is stored (N/m) and length of acting
extern float beamLength; //Length of a beam
